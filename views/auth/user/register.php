...
<head>
  ...
  <title>Bumi Tekno Store | Register in</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?= baseUrl() ?>"><b>Bumi Tekno Store</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="registration.php" method="post">
          ...
          <div class="social-auth-links text-center mb-3">
            <button class="btn btn-primary btn-block" name="post" type="submit">Register</button>
          </div>
        </form>
      </div>
      <!-- /.login-card-body -->
