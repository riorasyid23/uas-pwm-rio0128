...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2022 at 02:26 PM
...
INSERT INTO `users` (`id`, `name`, `username`, `level`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Riyan Alfian', 'riyan@gmail.com', 'user', 'password', NULL, NULL, NULL, NULL, NULL),
(2, 'admin', 'admin@gmail.com', 'admin', 'password', NULL, NULL, NULL, NULL, NULL);
